    ...
    create table RS_COLUMN (
        ...
        export_null_as_string boolean not null,
        hidden boolean,
    ...
    create table RS_LDAP_SERVER (
        ...
        flatten_tree boolean not null,
        ldap_base varchar(255),
        ldap_disabled boolean not null,
        ldap_filter varchar(1024),
        log_resulting_tree boolean not null,
        provider_host varchar(255),
        provider_port int4 not null,
        security_credentials varchar(255),
        security_encryption varchar(20),
        security_principal varchar(255),
        write_protection boolean not null,
        id int8 not null,
        external_dir_id int8,
        primary key (id)
    );
    ...
    create table RS_LDAP_SERVER_A (
        ...
        attr_user_obj_class varchar(255),
        attr_user_username varchar(255),
        flatten_tree boolean,
        ldap_base varchar(255),
        ldap_disabled boolean,
        ldap_filter varchar(1024),
        log_resulting_tree boolean,
        provider_host varchar(255),
        provider_port int4,
        security_credentials varchar(255),
        security_encryption varchar(20),
    ...
    create table RS_TABLE_DATASINK (
        ...
        truncate_table boolean not null,
        id int8 not null,
        datasource_container_id int8,
        primary key (id)
    );
