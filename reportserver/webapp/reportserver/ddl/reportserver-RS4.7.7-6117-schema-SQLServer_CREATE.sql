    ...
    create table RS_COLUMN (
        ...
        export_null_as_string bit not null,
        hidden bit,
    ...
    create table RS_DADGET_REPORT (
        config varchar(MAX),
        show_execute_button bit not null,
        id bigint not null,
        report_id bigint,
    ...
    create table RS_EMAIL_DATASINK (
        ...
        tls_enable bit not null,
        tls_require bit not null,
        username varchar(255),
        id bigint not null,
        primary key (id)
    );
    ...
    create table RS_LDAP_SERVER_A (
        ...
        ldap_disabled bit,
        ldap_filter varchar(1024),
        log_resulting_tree bit,
        provider_host varchar(255),
        provider_port int,
        security_credentials varchar(255),
        security_encryption varchar(20),
        security_principal varchar(255),
        write_protection bit,
        external_dir_id bigint,
        primary key (id, REV)
    );
    ...
    create table RS_TABLE_DATASINK (
        ...
        copy_primary_keys bit not null,
        primary_keys varchar(2048),
        table_name varchar(1024),
        truncate_table bit not null,
        id bigint not null,
        datasource_container_id bigint,
        primary key (id)
    );
