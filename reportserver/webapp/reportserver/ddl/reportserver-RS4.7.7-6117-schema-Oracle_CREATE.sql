    ...
    create table RS_LDAP_SERVER (
        attr_add varchar2(1024 char),
        attr_group_member varchar2(255 char),
        attr_group_name varchar2(255 char),
        attr_group_obj_class varchar2(255 char),
        attr_guid varchar2(255 char),
        attr_obj_class varchar2(255 char),
        attr_org_unit_obj_class varchar2(255 char),
        attr_org_unit_obj_name varchar2(255 char),
        attr_user_firstname varchar2(255 char),
        attr_user_lastname varchar2(255 char),
        attr_user_mail varchar2(255 char),
        attr_user_obj_class varchar2(255 char),
        attr_user_username varchar2(255 char),
        flatten_tree number(1,0) not null,
        ldap_base varchar2(255 char),
        ldap_disabled number(1,0) not null,
        ldap_filter varchar2(1024 char),
        log_resulting_tree number(1,0) not null,
        provider_host varchar2(255 char),
        provider_port number(10,0) not null,
        security_credentials varchar2(255 char),
        security_encryption varchar2(20 char),
        security_principal varchar2(255 char),
        write_protection number(1,0) not null,
        id number(19,0) not null,
        external_dir_id number(19,0),
        primary key (id)
    );
    ...
    create table RS_LDAP_SERVER_A (
        ...
        attr_user_obj_class varchar2(255 char),
        attr_user_username varchar2(255 char),
        flatten_tree number(1,0),
        ldap_base varchar2(255 char),
        ldap_disabled number(1,0),
        ldap_filter varchar2(1024 char),
        log_resulting_tree number(1,0),
        provider_host varchar2(255 char),
        provider_port number(10,0),
        security_credentials varchar2(255 char),
        security_encryption varchar2(20 char),
        security_principal varchar2(255 char),
        write_protection number(1,0),
        external_dir_id number(19,0),
        primary key (id, REV)
    );
    ...
    insert into RS_SCHEMAINFO(ENTITY_ID, KEY_FIELD, value) VALUES((select max(i.ENTITY_ID)+1 ENTITY_ID from (select ENTITY_ID from RS_SCHEMAINFO union select 1 ENTITY_ID from dual)i), 'version', 'RS4.7.7-6117');
    insert into RS_SCHEMAINFO(ENTITY_ID, KEY_FIELD, value) VALUES((select max(i.ENTITY_ID)+1 ENTITY_ID from (select ENTITY_ID from RS_SCHEMAINFO union select 1 ENTITY_ID from dual)i), 'schemaversion', 'RS3.0-29');
