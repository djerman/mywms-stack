...
# use reportserver; 
    ...
    create table RS_COLUMN (
        ...
        export_null_as_string BIT(1) not null,
        hidden BIT(1),
    ...
    create table RS_LDAP_SERVER (
        attr_add varchar(1024),
        attr_group_member varchar(255),
        attr_group_name varchar(255),
        attr_group_obj_class varchar(255),
        attr_guid varchar(255),
        attr_obj_class varchar(255),
        attr_org_unit_obj_class varchar(255),
        attr_org_unit_obj_name varchar(255),
        attr_user_firstname varchar(255),
        attr_user_lastname varchar(255),
        attr_user_mail varchar(255),
        attr_user_obj_class varchar(255),
        attr_user_username varchar(255),
        flatten_tree BIT(1) not null,
        ldap_base varchar(255),
        ldap_disabled BIT(1) not null,
        ldap_filter varchar(1024),
        log_resulting_tree BIT(1) not null,
        provider_host varchar(255),
        provider_port integer not null,
        security_credentials varchar(255),
        security_encryption varchar(20),
        security_principal varchar(255),
        write_protection BIT(1) not null,
        id bigint not null,
        external_dir_id bigint,
        primary key (id)
    ) CHARACTER SET utf8 COLLATE utf8_bin;

    create table RS_LDAP_SERVER_A (
        id bigint not null,
        REV integer not null,
        attr_add varchar(1024),
        attr_group_member varchar(255),
        ...
        ldap_disabled BIT(1),
        ldap_filter varchar(1024),
        log_resulting_tree BIT(1),
        provider_host varchar(255),
        provider_port integer,
        security_credentials varchar(255),
        security_encryption varchar(20),
        security_principal varchar(255),
        write_protection BIT(1),
        external_dir_id bigint,
        primary key (id, REV)
    ) CHARACTER SET utf8 COLLATE utf8_bin;
    ...
    create table RS_TABLE_DATASINK (
        ...
        copy_primary_keys BIT(1) not null,
        primary_keys varchar(2048),
        table_name varchar(1024),
        truncate_table BIT(1) not null,
        id bigint not null,
        datasource_container_id bigint,
        primary key (id)
    ) CHARACTER SET utf8 COLLATE utf8_bin;
    ...
    create table RS_TABLE_DATASINK_A (
        ...
        REV integer not null,
        batch_size integer,
        copy_primary_keys BIT(1),
        primary_keys varchar(2048),
        table_name varchar(1024),
        truncate_table BIT(1),
        datasource_container_id bigint,
        primary key (id, REV)
    ) CHARACTER SET utf8 COLLATE utf8_bin;
    ...
    alter table RS_LDAP_SERVER 
        add index FK_29cvhxyq59e875hohoh8r5w7m (external_dir_id), 
        add constraint FK_29cvhxyq59e875hohoh8r5w7m 
        foreign key (external_dir_id) 
        references RS_ORGANISATIONAL_UNIT (id);

    alter table RS_LDAP_SERVER 
        add index FK_j0a4tw2jhqc7a1loea8qro2n7 (id), 
        add constraint FK_j0a4tw2jhqc7a1loea8qro2n7 
        foreign key (id) 
        references RS_REMOTE_SERVER_DEFINITION (id);

    alter table RS_LDAP_SERVER_A 
        add index FK_ifqiuma7xiy7vvbo45v2rtus (id, REV), 
        add constraint FK_ifqiuma7xiy7vvbo45v2rtus 
        foreign key (id, REV) 
        references RS_REMOTE_SERVER_DEFINITION_A (id, REV);
    ...
    alter table RS_PRINTER_DATASINK 
        add index FK_s5apg1lov8pxkephkli0p674e (id), 
        add constraint FK_s5apg1lov8pxkephkli0p674e 
        foreign key (id) 
        references RS_DATASINK_DEFINITION (id);

    alter table RS_PRINTER_DATASINK_A 
        add index FK_n3e0ca9a2olya1fn9ra5j2jw0 (id, REV), 
    ...
    alter table RS_SCHED_ACTION_AS_PRINTER_FILE 
        add index FK_lpowasos3pw5go6nqokslqco (printer_datasink_id), 
        add constraint FK_lpowasos3pw5go6nqokslqco 
        foreign key (printer_datasink_id) 
        references RS_PRINTER_DATASINK (id);

    alter table RS_SCHED_ACTION_AS_PRINTER_FILE 
        add index FK_rmbk647lwidwkr3grdl1olueq (id), 
    ...
    alter table RS_SCHED_ACTION_AS_SCRIPT_DATASINK 
        add index FK_t5l3n53sif93n3b52rh6hgxa5 (script_datasink_id), 
        add constraint FK_t5l3n53sif93n3b52rh6hgxa5 
        foreign key (script_datasink_id) 
        references RS_SCRIPT_DATASINK (id);

    alter table RS_SCHED_ACTION_AS_SCRIPT_DATASINK 
        add index FK_trhhdk2j01kqayvqv5oq4jmxk (id), 
    ...
    alter table RS_SCHED_ACTION_AS_TABLE_DATASINK_FILE 
        add index FK_m9q4rcvmvm4p103lgk4rtc4a (table_datasink_id), 
        add constraint FK_m9q4rcvmvm4p103lgk4rtc4a 
        foreign key (table_datasink_id) 
        references RS_TABLE_DATASINK (id);

    alter table RS_SCHED_ACTION_AS_TABLE_DATASINK_FILE 
        add index FK_kgj928psuyegbmylearshe3fw (id), 
    ...
    alter table RS_SCRIPT_DATASINK 
        add index FK_lls938f1gkgc05k0kg40thrgm (script_id), 
        add constraint FK_lls938f1gkgc05k0kg40thrgm 
        foreign key (script_id) 
        references RS_FILE_SERVER_FILE (id);

    alter table RS_SCRIPT_DATASINK 
        add index FK_ltqkdm12h1icc6vvf84wldklb (id), 
        add constraint FK_ltqkdm12h1icc6vvf84wldklb 
        foreign key (id) 
        references RS_DATASINK_DEFINITION (id);

    alter table RS_SCRIPT_DATASINK_A 
        add index FK_j5jypnfvpy1bsqqqwg2l9pv3h (id, REV), 
    ...
    alter table RS_TABLE_DATASINK 
        add index FK_mpacg66ugqwk9o5qp7q9hueea (datasource_container_id), 
        add constraint FK_mpacg66ugqwk9o5qp7q9hueea 
        foreign key (datasource_container_id) 
        references RS_DATASOURCE_CONTAINER (ENTITY_ID);

    alter table RS_TABLE_DATASINK 
        add index FK_s9r3o6x12qxcxawok15rxdsc1 (id), 
        add constraint FK_s9r3o6x12qxcxawok15rxdsc1 
        foreign key (id) 
        references RS_DATASINK_DEFINITION (id);

    alter table RS_TABLE_DATASINK_A 
        add index FK_7pb7s46f11f524q9pe9prsvd3 (id, REV), 
    ...
    insert into RS_SCHEMAINFO(KEY_FIELD, value) VALUES('version', 'RS4.7.7-6117');
    insert into RS_SCHEMAINFO(KEY_FIELD, value) VALUES('schemaversion', 'RS3.0-29');
