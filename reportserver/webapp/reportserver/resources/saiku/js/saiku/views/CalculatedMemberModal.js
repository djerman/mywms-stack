    ...
    template_modal: _.template(
        ...
        '<div class="cms-container-form">' +
            '<form class="form-group-inline" data-action="cad">' +
                ...
                ' <a href="#" class="i18n form-control btn-primary btn btn-select-member"' +
                'id="insertmember" style="color:white; font-size:12px">Select Member</a> </div>' +
        ...
        ' href="#add_math_operator_formula" data-math="or">or</a>' +
					...
					' <a href="#" class="i18n form_button btn btn-primary growthBtn"#'+
						' style="color:white; font-size:12px" id="growthBtn" >Predefined Calculations</a> ' +
					' <a href="#" class="i18n form_button btn btn-primary formatBtn"' +
                    	' style="color:white; font-size:12px" id="formatBtn"  ' +
					' ">Format %</a>' +
				'</div><br/>' +
                ...
                '<select id="cms-dimension" class="form-control" style="width:365px">' +
                    ...
                    '<% if (measures.length > 0) { %>' +
                        ...
                        '<optgroup class="i18n" label="<%= dataMeasures.name %>">' +
                            '<option class="i18n" value="<%= dataMeasures.uniqueName %>" data-type="calcmeasure"><%= dataMeasures.name %></option>' +
                        '</optgroup>' +
                    '<% } %>' +
                ...
                '<div class="btn-groups" style="padding-bottom:10px">' +
                    ...
                    '<a class="i18n form_button btn btn-primary btn-parent-member" style="color:white; font-size:12px" href="#add_math_operator_formula"' +
                    ' disabled>Parent Member Selector</a>' +
                    '<a class="i18n form_button btn btn-default btn-clear-parent" style="font-size:12px" href="#add_math_operator_formula"' +
                    ' disabled>Clear Parent Member</a>' +
                '</div>' +
