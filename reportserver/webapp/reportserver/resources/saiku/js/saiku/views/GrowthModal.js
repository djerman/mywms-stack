...
var GrowthModal = Modal.extend({
	...
	addMeasureTemplate: _.template(
		...
		"<span class=\"i18n\">Calculate difference of a measure over dimension members</span>" +
		...
		'<input type="checkbox" name="asPercent" value="asPercent" id="asPercentCheckbox">&nbsp;<span class=\"i18n\">Relative %</span><br>' +
		'<% if(dimensions.length<2){ %>'+
		//'<input type="checkbox" name="asPercentAlt" disabled value="asPercentAlt" id="asPercentAltCheckbox"> % of Measure<br>' +
		'<input type="checkbox" name="asPercentAlt" disabled value="asPercentAlt" id="asPercentAltCheckbox">&nbsp;<span class=\"i18n\">% of Measure</span><br>' +
		'<% }  else {%>'+
		//'<input type="checkbox" name="asPercentAlt" value="asPercentAlt" id="asPercentAltCheckbox"> % of Measure<br>' +
		'<input type="checkbox" name="asPercentAlt" value="asPercentAlt" id="asPercentAltCheckbox">&nbsp;<span class=\"i18n\">% of Measure</span><br>' +
		'<% }%>'+
		...
		'<input type="checkbox" name="asPercentAround100" value="asPercentAround100" id="asPercentAround100Checkbox">&nbsp;<span class=\"i18n\">Relative around 100%</span> <br>' +
		...
		"    <option value='' class='i18n' selected='selected'>--select a dimension from your query--</option> " +
