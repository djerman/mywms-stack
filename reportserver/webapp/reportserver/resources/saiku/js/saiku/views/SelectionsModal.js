...
var SelectionsModal = Modal.extend({
    ...
    initialize: function(args) {
        ...
        this.options.title = "<span class='i18n'>Selections for</span>" + "&nbsp;<span class='i18n'>" + this.name + "</span>";
    ...
    post_render: function(args) {
        ...
        $(args.modal.el).parents('.ui-dialog')
            .css({ width: width, left: "inherit", margin:"0", height: 605 })
            .offset({ left: left});
    ...
    save: function() {
        ...
        /* update filter icon in drop zone */
