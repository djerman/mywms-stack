...
var FormatAsPercentageModal = Modal.extend({
	...
	addMeasureTemplate: _.template(
		...
		"    <a href='#' style='color:white; font-size:12px;' class='i18n form_button btn btn-primary formatButton' id='formatOverRows'>Format as % of rows</a></li>" +
		"<li style='padding-bottom: 10px; padding-right: 10px; float: inherit;'>     " +
		//"    <button class='form_button btn btn-primary formatButton' id='formatOverColumns'> Format as % of columns </button></li>" +
		"    <a href='#' style='color:white; font-size:12px;' class='i18n form_button btn btn-primary formatButton' id='formatOverColumns'>Format as % of columns</a></li>" +
		"<li style='padding-bottom: 10px; padding-right: 10px; float: inherit;'>     " +
		//"    <button class='form_button formatButton btn btn-primary' id='formatOverTotal'> Format as % of total </button></li>" +
		"    <a href='#' style='color:white; font-size:12px;' class='i18n form_button formatButton btn btn-primary' id='formatOverTotal'>Format as % of total</a></li>" +
		"</ol>" +
