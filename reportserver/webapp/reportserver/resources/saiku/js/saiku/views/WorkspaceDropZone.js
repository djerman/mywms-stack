                ...
                _.each(axes[axis].hierarchies, function(hierarchy) {
					if(self.workspace.dimension_list!=null) {
						...
						for (var level in hierarchy.levels) {
							...
							var theLevel = hierarchy.levels[level];
	                        if(null !== theLevel && typeof theLevel === 'object' &&
	                           null !== theLevel.selection && typeof theLevel.selection === 'object' &&
	                           null !== theLevel.selection.members && typeof theLevel.selection.members === 'object' && theLevel.selection.members.length > 0){
	                                h.find('li a[level="' + level + '"]').addClass('rs-filtered');
	                        }
            ...
            build: function($trigger, e) {
                ...
                var citems = {
                        ...
                        "limit" : {name: "Limit", i18n: true, items:
                        {
                                ...
                                "TopCountQuick" : { name: "Top 10 by...", className: "context-menu-list-scroll", i18n: true, items: addFun(items, "TopCount") },
                                "BottomCountQuick" : { name: "Bottom 10 by...", className: "context-menu-list-scroll", i18n: true, items: addFun(items, "BottomCount") },
                        ...
                        "sort" : {name: "Sort", i18n: true, items:
                        {
	                        ...
	                        "ASCQuick": {name: "Ascending", className: "context-menu-list-scroll", i18n: true, items: addFun(items, "ASC") },
                            "DESCQuick": {name: "Descending", className: "context-menu-list-scroll",i18n: true, items: addFun(items, "DESC")},
                            "BASCQuick": {name: "Ascending (Breaking Hierarchy)", className: "context-menu-list-scroll",i18n: true, items: addFun(items, "BASC")},
                            "BDESCQuick": {name: "Descending (Breaking Hierarchy)", className: "context-menu-list-scroll", i18n: true, items: addFun(items, "BDESC") },
